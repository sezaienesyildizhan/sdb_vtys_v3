...
<nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
            <a class="nav-link active me-2 fw-bold" aria-current="page" href=""></a>
            </li>
            
            <li class="nav-item">
            <a class="nav-link active me-2 fw-bold" href=""></a>
            </li>
        ...
        <form class="d-flex">
            ...
            <a href="../account/accountdetails.php" class="btn btn-outline-dark shadow-none me-lg-3 me-2">
               Hesabım
            </a>
